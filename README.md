...
| 항목 | 내용 |
|------|------|
| 서비스명 | SKU-SKU (성결대 멋쟁이사자처럼 웹사이트 SKU-SKU 2025 리뉴얼 — 프로젝트 포트폴리오

> 성결대 멋쟁이사자처럼(LikeLion) 동아리의 공식 운영 플랫폼. 실제 배포·운영 중인 서비스에 프론트엔드 개발자로 참여하여, 사용자 페이지 3종과 어드민 페이지 4종을 설계부터 구현까지 담당.
